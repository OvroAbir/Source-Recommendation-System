...
def get_processed_words(title):
    ...
    if("/s/chopin/k/grad/deotales/nltk_data" not in nltk.data.path):
        nltk.data.path.append("/s/chopin/k/grad/deotales/nltk_data")
...
def main(inputfolderpath, outputfolderpath, jobname):
    ...
    sc = SparkContext(master="spark://richmond.cs.colostate.edu:53101", appName=jobname)
